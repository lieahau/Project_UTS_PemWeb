...
CREATE TABLE `comment` (
  ...
  `comment_in` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `comment_by` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `comment_content` varchar(2000) COLLATE utf8mb4_unicode_ci NOT NULL
...
CREATE TABLE `status` (
  ...
  `writed_by` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status_content` varchar(2000) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `user` (
  ...
  `PPLocation` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
